...
/// Shelf-edition venue: identical to the wallet venue. USDG quote + the
/// fifteen Hood Chain stocks that have both a live feed and a real USDG pool,
/// each pinned to its deepest sensible fee tier, measured on-chain 2026-08-31.
/// Frozen at deploy forever.
contract DeployShelf is Script {
    address constant ROUTER = 0xCaf681a66D020601342297493863E78C959E5cb2;
    address constant USDG   = 0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168;

    function run() external {
        vm.startBroadcast();
        AUM0Shelf aum = _deploy();
        vm.stopBroadcast();
        console2.log("AUM0 shelf edition deployed at:", address(aum));
    }

    function deployForTest() external returns (AUM0Shelf) {
        return _deploy();
    }

    function _deploy() internal returns (AUM0Shelf) {
        ...
        return new AUM0Shelf(ROUTER, USDG, 6, 7 days, tokens, feeds, fees, decs);
    }
